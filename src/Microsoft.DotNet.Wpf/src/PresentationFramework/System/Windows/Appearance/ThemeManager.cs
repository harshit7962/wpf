...
using System.Windows.DesignTime;
    ...
    public class ThemeManager : DependencyObject
    {
        ...
        private static readonly DependencyPropertyKey ActualApplicationThemePropertyKey =
            DependencyProperty.RegisterReadOnly(
                ...
                typeof(ApplicationTheme),
                typeof(ThemeManager),
                new PropertyMetadata(System.Windows.Appearance.ApplicationTheme.Light, OnActualApplicationThemeChanged));
        ...
        private static void OnActualApplicationThemeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            switch (newValue)
            {
                case System.Windows.Appearance.ApplicationTheme.Light:
                    tm._defaultActualTheme = ElementTheme.Light;
                    break;
                case System.Windows.Appearance.ApplicationTheme.Dark:
        ...
        private void UpdateActualApplicationTheme()
        {
            ...
            {
                ActualApplicationTheme = ApplicationTheme ?? System.Windows.Appearance.ApplicationTheme.Light;
            }
        }
        ...
        private static readonly DependencyProperty InheritedApplicationThemeProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(ApplicationTheme),
                typeof(ThemeManager),
                new PropertyMetadata(System.Windows.Appearance.ApplicationTheme.Light, OnInheritedApplicationThemeChanged));
